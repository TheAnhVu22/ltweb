<?php
	...
	if(isset($_SESSION['nhacungcap_login']) && $_SESSION['nhacungcap_login'] == true){
		$ncc_ma = $_SESSION['ncc_ma'];
			...
			$sql1 = "SELECT * FROM donhang,nguoidung,nhavanchuyen,nhacungcap WHERE dh_ma='$dh_ma'AND donhang.mand=nguoidung.ma AND donhang.manvc=nhavanchuyen.nvc_ma AND donhang.mancc=nhacungcap.ncc_ma";
	...
	<div class="container">
		...
		<tbody>
			...
			<tr style="height:40px;vertical-align:bottom;">
				...
				if($mangdl['trangthai'] == 0) {
					?>
				<a href="xacnhan.php?id=<?php echo $dh_ma; ?>"><input type="button" value="Xác nhận đơn hàng" class="btn btn-success"/></a>
				<?php
				}
				?>
		</div>	
