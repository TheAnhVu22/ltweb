<?php
	...
	if(isset($_SESSION['admin_login'])&&$_SESSION['admin_login'] == true){
			$dulieu = "SELECT * FROM nhavanchuyen";
...
<body>
	...
	<div class="container">
		...
		<?php include('nhavanchuyen_them.php'); ?>
