<?php
	...
	session_start();
		...
		if(isset($_SESSION['nhavanchuyen_login']) && isset($_SESSION['nvc_ma'])) {
			if($_SESSION['sessUsername']!=NULL) {
			$manvc = $_SESSION['nvc_ma'];
				$dulieu = "SELECT * FROM donhang,nguoidung WHERE donhang.mand=nguoidung.ma AND donhang.manvc = $manvc ORDER BY trangthai,dh_ma DESC;";
...
<html>
<head>
	<title> Danh sách đơn vận chuyển </title>
...
<body>
	...
	<?php include("../includes/menu_nhavc.php") ?>
		...
		<h1>Danh sách đơn vận chuyển</h1>
